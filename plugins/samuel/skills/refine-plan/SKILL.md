...
> **Tracker**: `../../reference/tracker.md`. **Adapter**: `../../reference/github-operations.md`. **Plan format**: `../../reference/plan-templates.md`. After applying edits, set `phase: plan` + `last_updated` in `.claude/task-context/{item}.md` (an iteration returns the pipeline to the plan gate).
