...
> Mirror of the interview technique in `../find-unknowns/SKILL.md` § The four quadrants — one question per turn, ranked by blast radius, because sequencing lets each answer reshape the next question.
